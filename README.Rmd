...
The `arima` function is implemented by modifying the source code of the `stats::arima` function. 
...
One can visualize the roots of the fitted model, by specifying the argument `roots = TRUE`:
